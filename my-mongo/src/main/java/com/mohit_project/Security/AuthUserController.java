...
public class AuthUserController {
	...
	public AuthUserController(JwtService jwtService, AuthUserService authenticationUserService) {
		this.jwtService = jwtService;
		this.authenticationUserService = authenticationUserService;
	}
    @PostMapping("/signup")
    public ResponseEntity<User> register(@RequestBody UserDto registerUserDto) {
        User registeredUser = authenticationUserService.signup(registerUserDto);
	...
	public ResponseEntity<LoginResponse> authenticate(@RequestBody LoginDto user) {
		this.logger.warn("calling authentication");
		User authenticatedUser = authenticationUserService.authenticateUser(user);
